...
public class MilitaryUnit
{
    ...
    public int TransportCapacity
    {
        get
        {
            ...
            return (int)Math.Ceiling(Personnel * Size) - Transporting.Sum(x => x.TransportSize);
        }
    }
    ...
    public MoveCommand GetMoveOrderToDestination(Tile destination)
    {
        ...
        return ShortestPathToMoveCommand(shortestPath);
    }

    public MoveCommand ShortestPathToMoveCommand(PathFindTile[] shortestPath)
    {
