...
namespace Tests
{
    ...
    public class MoveTests
    {
        ...
        public void InfantryValidMoveList()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithUnitMoves.png", board.Tiles, board.Edges, board.Structures, null, null, units);
        ...
        public void InfantryValidMoveListWithRoad()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithUnitMovesOverRoad.png", board.Tiles, board.Edges, board.Structures, null, null, units);
        ...
        public void InfantryValidMoveListWithRoadOverMountain()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithUnitMovesOverRoadOverMountain.png", board.Tiles, board.Edges, board.Structures, null, null, units);
        ...
        public void AirborneValidMoveListWithRoadAndMountain()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithAirborneUnitMovesWithRoadAndMountain.png", board.Tiles, board.Edges, board.Structures, null, null, units);
        ...
        public void AirborneValidMoveList()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithAirborneUnitMoves.png", board.Tiles, board.Edges, board.Structures, null, null, units);
        ...
        public void BasicBoardWithLandUnitNearRiverAndRoad()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithLandUnitNearBrdigeAndRoad.png", board.Tiles, board.Edges, board.Structures, null, null, units);
        ...
        public void BasicBoardWithLandUnitNearBridgeAndRoad()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithLandUnitNearBridgeAndRoad.png", board.Tiles, board.Edges, board.Structures, null, null, units);
        ...
        public void BasicBoardWithAmphibiousUnitNearRiverAndRoad()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithAmphibiousUnitNearRiverAndRoad.png", board.Tiles, board.Edges, board.Structures, null, null, units);
        ...
        public void BasicBoardWithAquaticUnit()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithAquaticUnit.png", board.Tiles, board.Edges, board.Structures, null, null, units);
        ...
        public void ResolveMove_ConflictArrises_ConflictedUnitsStop()
        {
            ...
            Visualise.Integration.RenderAndSave("BasicBoardWithUnitsPreMove.png", board.Tiles, board.Edges, board.Structures, null, vectors, board.Units);

            board.ResolveMoves(moveOrders);

            Visualise.Integration.RenderAndSave("BasicBoardWithUnitsPostMove.png", board.Tiles, board.Edges, board.Structures, null, null, board.Units);
